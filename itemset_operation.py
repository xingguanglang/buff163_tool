...
from item_filter import generate_item_list_from_deep_partition,generate_item_list_from_buff_item,create_item_lists_from_deep_partition_list
...
def generate_itemset_item(itemset:itemset):
    ...
    for a in tmp:
        for i in a:
            ...
            create_item_lists_from_deep_partition_list(read_deep_partition_from_json(filepath))
    return 